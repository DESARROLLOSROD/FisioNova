...
import { PlusCircle, Activity, LayoutGrid } from 'lucide-react'
...
export default function MeasurementLog({ patientId, initialHistory }: MeasurementLogProps) {
    const [view, setView] = useState<'charts' | 'bodymap'>('charts')
    ...
    const handleSubmit = async () => {
        ...
        try {
            const data: MeasurementData = {
                ...
                metric: view === 'charts' ? (metric as any) : 'body_map',
                notes: notes,
            }
                ...
                <div className="md:col-span-2 space-y-6">
                    {view === 'charts' ? (
                        <EvolutionChart
                            ...
                            metricName={metric}
                            color={metric === 'dolor' ? '#ef4444' : '#2563eb'}
                        />
                    ) : (
